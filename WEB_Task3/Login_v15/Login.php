...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="Login.php" name="myform" method="POST">
					...
					<div class="flex-sb-m w-full p-b-30">
						<div>
							<a href="Register.php" class="txt1" name="register">
								Register
							</a>
						</div>
					</div>
	 ...
	 if(@$_POST['username'] != null && $_POST['password'] != null)
	{
		...
		if(trim($dbName) == trim($username) && trim($dbPassword) == trim($password)){
	
			@header("Location: Pay.php");
			echo "<script> alert('Welcome'.$dbUsername.' '.$dbSurname.);window.location='Pay.php'</script>";
			$_SESSION['user'] = "true";
			$_SESSION['userid'] = $dbCustomerID;
